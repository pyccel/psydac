...
def assembly(global_test_basis_v_1, global_test_basis_v_2, global_trial_basis_u_1, global_trial_basis_u_2, global_span_v_1, global_span_v_2, global_x1, global_w1, global_x2, global_w2, test_v_p1, test_v_p2, trial_u_p1, trial_u_p2, n_element_1, n_element_2, k1, k2, pad1, pad2, l_mat_u_v_oqyl00rw, g_mat_u_v_oqyl00rw):
    ...
    for i_element_1 in range(0, n_element_1, 1):
        ...
        for i_element_2 in range(0, n_element_2, 1):
                        ...
                        for j_basis_2 in range(0, 1 + trial_u_p2, 1):
                            for i_quad_1 in range(0, 3, 1):
                                ...
                                for i_quad_2 in range(0, 3, 1):
                                    ...
                                    u_x2 = u_1*u_2_x2
                                    u_x1 = u_1_x1*u_2
                                    l_mat_u_v_oqyl00rw[i_basis_1,i_basis_2,-i_basis_1 + j_basis_1 + pad_u_v_1,-i_basis_2 + j_basis_2 + pad_u_v_2] += wvol_M_Square*(u_x1*v_x1 + u_x2*v_x2)
            ...
            g_mat_u_v_oqyl00rw[pad1 + span_v_1 - test_v_p1 : 1 + pad1 + span_v_1,pad2 + span_v_2 - test_v_p2 : 1 + pad2 + span_v_2, : , : ] += l_mat_u_v_oqyl00rw[ : , : , : , : ]
