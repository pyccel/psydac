import os
import numpy as np
from psydac.feec.multipatch.examples_nc.tharm_compare_nc import solve_hcurl_source_pbm
...
nc_s = [np.array([16, 16, 16, 16, 16, 8, 8, 8, 8, 8, 8, 8, 8, 16, 16, 16, 8, 8])]
