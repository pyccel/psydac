...
subroutine assembly(n0_global_test_basis_v_1, n1_global_test_basis_v_1, &
      ...
      n0_l_vec_v_crg5c5jf, n1_l_vec_v_crg5c5jf, l_vec_v_crg5c5jf, &
      n0_g_vec_v_crg5c5jf, n1_g_vec_v_crg5c5jf, g_vec_v_crg5c5jf)

  use dependencies_crg5c5jf, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_vec_v_crg5c5jf
  integer(kind=4), intent(in) :: n1_l_vec_v_crg5c5jf
  real(kind=8), intent(inout) :: l_vec_v_crg5c5jf(0: &
      n1_l_vec_v_crg5c5jf-1,0:n0_l_vec_v_crg5c5jf-1)
  integer(kind=4), intent(in) :: n0_g_vec_v_crg5c5jf
  integer(kind=4), intent(in) :: n1_g_vec_v_crg5c5jf
  real(kind=8), intent(inout) :: g_vec_v_crg5c5jf(0: &
      n1_g_vec_v_crg5c5jf-1,0:n0_g_vec_v_crg5c5jf-1)
  ...
  !f2py integer(kind=8) :: n0_l_vec_v_crg5c5jf=shape(l_vec_v_crg5c5jf,0)
  !f2py integer(kind=8) :: n1_l_vec_v_crg5c5jf=shape(l_vec_v_crg5c5jf,1)
  !f2py intent(c) l_vec_v_crg5c5jf
  !f2py integer(kind=8) :: n0_g_vec_v_crg5c5jf=shape(g_vec_v_crg5c5jf,0)
  !f2py integer(kind=8) :: n1_g_vec_v_crg5c5jf=shape(g_vec_v_crg5c5jf,1)
  !f2py intent(c) g_vec_v_crg5c5jf
  call mod_assembly(global_test_basis_v_1, global_test_basis_v_2, &
      ...
      k2, pad1, pad2, l_vec_v_crg5c5jf, g_vec_v_crg5c5jf)
