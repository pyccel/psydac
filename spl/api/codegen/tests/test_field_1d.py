...
def test_eval_field_1d_1():
    print('============ test_eval_field_1d_1 =============')
...
def test_eval_field_1d_2():
    print('============ test_eval_field_1d_2 =============')

    V = FunctionSpace('V', ldim=1)

    F = Field('F', space=V)

    eval_field = EvalField(V, [F, dx(F), dx(dx(F))], name='eval_field')
    code = pycode(eval_field)
    print(code)
...
if __name__ == '__main__':
    ...
    test_eval_field_1d_1()
    test_eval_field_1d_2()
