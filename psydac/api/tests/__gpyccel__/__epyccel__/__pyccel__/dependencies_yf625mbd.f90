...
subroutine assembly(global_test_basis_v1_1, global_trial_basis_u1_1, &
  ...
  real(kind=8), intent(inout) :: l_mat_u1_v1_yf625mbd(0:,0:)
  real(kind=8), intent(inout) :: g_mat_u1_v1_yf625mbd(0:,0:)
  ...
  do i_element_1 = 0_8, n_element_1-1_8, 1_8
    ...
    do i_basis_1 = 0_8, 1_8 + test_v1_p1-1_8, 1_8
      ...
      ** 2_8
          l_mat_u1_v1_yf625mbd(-i_basis_1 + j_basis_1 + pad_u1_v1_1, &
      i_basis_1) = l_mat_u1_v1_yf625mbd(-i_basis_1 + j_basis_1 + &
      pad_u1_v1_1, i_basis_1) + 1.0d0 * u1 * v1 * wvol_M / sqrt(temp0)
        end do
      end do
    end do
    g_mat_u1_v1_yf625mbd(:, pad1 + span_v1_1 - test_v1_p1:1_8 + pad1 + &
      span_v1_1 - 1_8) = g_mat_u1_v1_yf625mbd(:, pad1 + span_v1_1 - &
      test_v1_p1:1_8 + pad1 + span_v1_1 - 1_8) + l_mat_u1_v1_yf625mbd( &
      :, :)
  end do
...
end module dependencies_yf625mbd
