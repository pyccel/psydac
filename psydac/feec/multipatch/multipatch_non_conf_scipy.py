...
def construct_V0_conforming_projection(V0h, domain_h, hom_bc=None, storage_fn=None):
    ...
    l2g = Local2GlobalIndexMapv0(ndim, len(domain), n_components)
    ...
    for I in Interfaces:
        ...
        I_minus_ncells = V0h.spaces[k_minus].spaces[d_minus].ncells
        I_plus_ncells = V0h.spaces[k_plus].spaces[d_plus].ncells
    ...
    if hom_bc:
        for bn in domain.boundary:
            ...
            multi_index_i[axis] = 0 if ext == - \
                1 else space_k.spaces[d].nbasis-1
