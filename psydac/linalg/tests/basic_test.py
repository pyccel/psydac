# old tests here will be converted to pytests and added to the test_linalg module
...
#    T3 = 2*(A + Z + G + Z + LS + 0.5*LS2 + H + B)
    ...
    print('4. "pcg"-"jacobi"-inverse of a BlockLinearOperator consisting of StencilMatrices')
    print()
    ...
    print('4. Creating the pcg jacobi inverse M_block_inv of a BlockLinearOperator M_block = ')
    print('[M, None]')
    print('[None, M]')
