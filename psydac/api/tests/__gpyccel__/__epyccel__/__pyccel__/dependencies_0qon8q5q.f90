...
subroutine assembly(global_test_basis_v0_1, global_trial_basis_u0_1, &
  ...
  real(kind=8), intent(inout) :: l_mat_u0_v0_0qon8q5q(0:,0:)
  real(kind=8), intent(inout) :: g_mat_u0_v0_0qon8q5q(0:,0:)
  ...
  do i_element_1 = 0_8, n_element_1-1_8, 1_8
    ...
    do i_basis_1 = 0_8, 1_8 + test_v0_p1-1_8, 1_8
      ...
      i_element_1)
          ...
          u0 = u0_1
          u0_x1 = u0_1_x1
          l_mat_u0_v0_0qon8q5q(-i_basis_1 + j_basis_1 + pad_u0_v0_1, &
      i_basis_1) = l_mat_u0_v0_0qon8q5q(-i_basis_1 + j_basis_1 + &
      pad_u0_v0_1, i_basis_1) + 1.0d0 * u0 * v0 * wvol_M * sqrt((0.25d0 &
      * cos(2_8 * 3.14159265358979d0 * x1) + 1.0d0) ** 2_8)
        end do
      end do
    end do
    g_mat_u0_v0_0qon8q5q(:, pad1 + span_v0_1 - test_v0_p1:1_8 + pad1 + &
      span_v0_1 - 1_8) = g_mat_u0_v0_0qon8q5q(:, pad1 + span_v0_1 - &
      test_v0_p1:1_8 + pad1 + span_v0_1 - 1_8) + l_mat_u0_v0_0qon8q5q( &
      :, :)
  end do
...
end module dependencies_0qon8q5q
