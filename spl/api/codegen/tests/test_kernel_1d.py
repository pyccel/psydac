...
def test_kernel_bilinear_1d_scalar_6(mapping=False):
    print('============ test_kernel_bilinear_1d_scalar_6 =============')
...
#    test_kernel_bilinear_1d_scalar_6(mapping=False)
...
#    test_kernel_bilinear_1d_scalar_6(mapping=True)
