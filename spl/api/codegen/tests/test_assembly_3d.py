...
def test_assembly_bilinear_3d_scalar_5(mapping=False):
    print('============ test_assembly_bilinear_3d_scalar_5 =============')
...
#    test_assembly_bilinear_3d_scalar_5(mapping=False)
...
#    test_assembly_bilinear_3d_scalar_5(mapping=True)
