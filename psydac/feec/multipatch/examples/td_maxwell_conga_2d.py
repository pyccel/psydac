...
def solve_td_maxwell_pbm(
    ...
    if source_type == 'zero':
    ...
    elif source_type in ['Il_pulse', 'Il_pulse_pp']:  #Issautier-like pulse
        pp = (source_type == 'Il_pulse_pp')
        # source will be 
        ...
        f0_harmonic = get_curl_free_pulse(x_0=1.0, y_0=1.0, domain=domain, pp=pp) # this is grad phi
        assert not source_is_harmonic

        rho0 = get_Delta_phi_pulse(x_0=1.0, y_0=1.0, domain=domain, pp=pp) # this is Delta phi
