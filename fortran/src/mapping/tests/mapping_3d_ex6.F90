...
implicit none
  ...
  real(plf_rk), dimension(:,:,:,:,:), allocatable :: arr_us
  real(plf_rk), dimension(:), allocatable :: grid_u 
  real(plf_rk), dimension(:), allocatable :: grid_v 
  real(plf_rk), dimension(:), allocatable :: grid_w 
