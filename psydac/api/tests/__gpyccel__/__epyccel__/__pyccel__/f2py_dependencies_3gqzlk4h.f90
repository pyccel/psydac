...
subroutine assembly(n0_global_test_basis_v1_1, n1_global_test_basis_v1_1 &
      ...
      trial_u1_p1, n_element_1, k1, pad1, n0_l_mat_u1_v1_3gqzlk4h, &
      n1_l_mat_u1_v1_3gqzlk4h, l_mat_u1_v1_3gqzlk4h, &
      n0_g_mat_u1_v1_3gqzlk4h, n1_g_mat_u1_v1_3gqzlk4h, &
      g_mat_u1_v1_3gqzlk4h)

  use dependencies_3gqzlk4h, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_mat_u1_v1_3gqzlk4h
  integer(kind=4), intent(in) :: n1_l_mat_u1_v1_3gqzlk4h
  real(kind=8), intent(inout) :: l_mat_u1_v1_3gqzlk4h(0: &
      n1_l_mat_u1_v1_3gqzlk4h-1,0:n0_l_mat_u1_v1_3gqzlk4h-1)
  integer(kind=4), intent(in) :: n0_g_mat_u1_v1_3gqzlk4h
  integer(kind=4), intent(in) :: n1_g_mat_u1_v1_3gqzlk4h
  real(kind=8), intent(inout) :: g_mat_u1_v1_3gqzlk4h(0: &
      n1_g_mat_u1_v1_3gqzlk4h-1,0:n0_g_mat_u1_v1_3gqzlk4h-1)
  ...
  !f2py integer(kind=8) :: n0_l_mat_u1_v1_3gqzlk4h=shape(l_mat_u1_v1_3gqzlk4h,0)
  !f2py integer(kind=8) :: n1_l_mat_u1_v1_3gqzlk4h=shape(l_mat_u1_v1_3gqzlk4h,1)
  !f2py intent(c) l_mat_u1_v1_3gqzlk4h
  !f2py integer(kind=8) :: n0_g_mat_u1_v1_3gqzlk4h=shape(g_mat_u1_v1_3gqzlk4h,0)
  !f2py integer(kind=8) :: n1_g_mat_u1_v1_3gqzlk4h=shape(g_mat_u1_v1_3gqzlk4h,1)
  !f2py intent(c) g_mat_u1_v1_3gqzlk4h
  call mod_assembly(global_test_basis_v1_1, global_trial_basis_u1_1, &
      ...
      n_element_1, k1, pad1, l_mat_u1_v1_3gqzlk4h, g_mat_u1_v1_3gqzlk4h &
      )
