...
subroutine assembly(n0_global_test_basis_v0_1, n1_global_test_basis_v0_1 &
      ...
      trial_u0_p1, n_element_1, k1, pad1, n0_l_mat_u0_v0_6dmvzcqk, &
      n1_l_mat_u0_v0_6dmvzcqk, l_mat_u0_v0_6dmvzcqk, &
      n0_g_mat_u0_v0_6dmvzcqk, n1_g_mat_u0_v0_6dmvzcqk, &
      g_mat_u0_v0_6dmvzcqk)

  use dependencies_6dmvzcqk, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_mat_u0_v0_6dmvzcqk
  integer(kind=4), intent(in) :: n1_l_mat_u0_v0_6dmvzcqk
  real(kind=8), intent(inout) :: l_mat_u0_v0_6dmvzcqk(0: &
      n1_l_mat_u0_v0_6dmvzcqk-1,0:n0_l_mat_u0_v0_6dmvzcqk-1)
  integer(kind=4), intent(in) :: n0_g_mat_u0_v0_6dmvzcqk
  integer(kind=4), intent(in) :: n1_g_mat_u0_v0_6dmvzcqk
  real(kind=8), intent(inout) :: g_mat_u0_v0_6dmvzcqk(0: &
      n1_g_mat_u0_v0_6dmvzcqk-1,0:n0_g_mat_u0_v0_6dmvzcqk-1)
  ...
  !f2py integer(kind=8) :: n0_l_mat_u0_v0_6dmvzcqk=shape(l_mat_u0_v0_6dmvzcqk,0)
  !f2py integer(kind=8) :: n1_l_mat_u0_v0_6dmvzcqk=shape(l_mat_u0_v0_6dmvzcqk,1)
  !f2py intent(c) l_mat_u0_v0_6dmvzcqk
  !f2py integer(kind=8) :: n0_g_mat_u0_v0_6dmvzcqk=shape(g_mat_u0_v0_6dmvzcqk,0)
  !f2py integer(kind=8) :: n1_g_mat_u0_v0_6dmvzcqk=shape(g_mat_u0_v0_6dmvzcqk,1)
  !f2py intent(c) g_mat_u0_v0_6dmvzcqk
  call mod_assembly(global_test_basis_v0_1, global_trial_basis_u0_1, &
      ...
      n_element_1, k1, pad1, l_mat_u0_v0_6dmvzcqk, g_mat_u0_v0_6dmvzcqk &
      )
