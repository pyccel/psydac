...
#==============================================================================
def run_poisson_2d_per_2(solution, f, ncells, degree, comm=None):
...
#==============================================================================
# 2D Poisson's equation with periodic BCs
#==============================================================================
def test_api_poisson_2d_per_1():
    ...
    l2_error, h1_error = run_poisson_2d_per_1(solution, f,
...
def test_api_poisson_2d_per_2():
    ...
    l2_error, h1_error = run_poisson_2d_per_2(solution, f,
                                             ncells=[2**4,2**4], degree=[2,2])
