...
def test_interface_bilinear_3d_scalar_5(mapping=False):
    print('============ test_interface_bilinear_3d_scalar_5 =============')
...
if __name__ == '__main__':
    ...
    test_interface_bilinear_3d_scalar_5(mapping=False)
...
#    test_interface_bilinear_3d_scalar_5(mapping=True)
