            ...
            for k_2 in range(0, n_element_2, 1):
                ...
                for q_2 in range(0, 3, 1):
                    ...
                    for k_3 in range(0, n_element_3, 1):
                        ...
                        for q_3 in range(0, 3, 1):
                            h_0 = h_arr[3 * k_1 + q_1, 3 * k_2 + q_2, 3 * k_3 + q_3, 0]
                            h_1 = h_arr[3 * k_1 + q_1, 3 * k_2 + q_2, 3 * k_3 + q_3, 1]
                            h_2 = h_arr[3 * k_1 + q_1, 3 * k_2 + q_2, 3 * k_3 + q_3, 2]
                            a4 = h_1 ** 2 + h_2 ** 2
