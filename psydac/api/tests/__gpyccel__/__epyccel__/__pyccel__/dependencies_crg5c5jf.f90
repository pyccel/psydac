...
subroutine assembly(global_test_basis_v_1, global_test_basis_v_2, &
  ...
  real(kind=8), intent(inout) :: l_vec_v_crg5c5jf(0:,0:)
  real(kind=8), intent(inout) :: g_vec_v_crg5c5jf(0:,0:)
  ...
  do i_element_1 = 0_8, n_element_1-1_8, 1_8
    ...
    do i_element_2 = 0_8, n_element_2-1_8, 1_8
      ...
      i_element_2)
              ...
              v_x2 = v_1 * v_2_x2
              v_x1 = v_1_x1 * v_2
              l_vec_v_crg5c5jf(i_basis_2, i_basis_1) = l_vec_v_crg5c5jf( &
      ...
      g_vec_v_crg5c5jf(pad2 + span_v_2 - test_v_p2:1_8 + pad2 + span_v_2 &
      - 1_8, pad1 + span_v_1 - test_v_p1:1_8 + pad1 + span_v_1 - 1_8) = &
      g_vec_v_crg5c5jf(pad2 + span_v_2 - test_v_p2:1_8 + pad2 + &
      span_v_2 - 1_8, pad1 + span_v_1 - test_v_p1:1_8 + pad1 + span_v_1 &
      - 1_8) + l_vec_v_crg5c5jf(:, :)
    end do
  end do
...
end module dependencies_crg5c5jf
