...
subroutine assembly(n0_global_test_basis_v1_1, n1_global_test_basis_v1_1 &
      ...
      trial_u1_p1, n_element_1, k1, pad1, n0_l_mat_u1_v1_3aqcgc4s, &
      n1_l_mat_u1_v1_3aqcgc4s, l_mat_u1_v1_3aqcgc4s, &
      n0_g_mat_u1_v1_3aqcgc4s, n1_g_mat_u1_v1_3aqcgc4s, &
      g_mat_u1_v1_3aqcgc4s)

  use dependencies_3aqcgc4s, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_mat_u1_v1_3aqcgc4s
  integer(kind=4), intent(in) :: n1_l_mat_u1_v1_3aqcgc4s
  real(kind=8), intent(inout) :: l_mat_u1_v1_3aqcgc4s(0: &
      n1_l_mat_u1_v1_3aqcgc4s-1,0:n0_l_mat_u1_v1_3aqcgc4s-1)
  integer(kind=4), intent(in) :: n0_g_mat_u1_v1_3aqcgc4s
  integer(kind=4), intent(in) :: n1_g_mat_u1_v1_3aqcgc4s
  real(kind=8), intent(inout) :: g_mat_u1_v1_3aqcgc4s(0: &
      n1_g_mat_u1_v1_3aqcgc4s-1,0:n0_g_mat_u1_v1_3aqcgc4s-1)
  ...
  !f2py integer(kind=8) :: n0_l_mat_u1_v1_3aqcgc4s=shape(l_mat_u1_v1_3aqcgc4s,0)
  !f2py integer(kind=8) :: n1_l_mat_u1_v1_3aqcgc4s=shape(l_mat_u1_v1_3aqcgc4s,1)
  !f2py intent(c) l_mat_u1_v1_3aqcgc4s
  !f2py integer(kind=8) :: n0_g_mat_u1_v1_3aqcgc4s=shape(g_mat_u1_v1_3aqcgc4s,0)
  !f2py integer(kind=8) :: n1_g_mat_u1_v1_3aqcgc4s=shape(g_mat_u1_v1_3aqcgc4s,1)
  !f2py intent(c) g_mat_u1_v1_3aqcgc4s
