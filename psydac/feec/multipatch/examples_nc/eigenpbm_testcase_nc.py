...
from psydac.feec.multipatch.examples_nc.eigenpb_compare_nc import hcurl_solve_eigen_pbm_multipatch_nc
...
print(dims)
run_dir = domain_name+str(dims)+'patches_'+'size_{}'.format(sz) #get_run_dir(domain_name, nc, deg)
