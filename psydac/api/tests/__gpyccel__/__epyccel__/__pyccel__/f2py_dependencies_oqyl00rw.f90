...
subroutine assembly(n0_global_test_basis_v_1, n1_global_test_basis_v_1, &
      ...
      k2, pad1, pad2, n0_l_mat_u_v_oqyl00rw, n1_l_mat_u_v_oqyl00rw, &
      n2_l_mat_u_v_oqyl00rw, n3_l_mat_u_v_oqyl00rw, l_mat_u_v_oqyl00rw, &
      n0_g_mat_u_v_oqyl00rw, n1_g_mat_u_v_oqyl00rw, &
      n2_g_mat_u_v_oqyl00rw, n3_g_mat_u_v_oqyl00rw, g_mat_u_v_oqyl00rw &
      )

  use dependencies_oqyl00rw, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n1_l_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n2_l_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n3_l_mat_u_v_oqyl00rw
  real(kind=8), intent(inout) :: l_mat_u_v_oqyl00rw(0: &
      n3_l_mat_u_v_oqyl00rw-1,0:n2_l_mat_u_v_oqyl00rw-1,0: &
      n1_l_mat_u_v_oqyl00rw-1,0:n0_l_mat_u_v_oqyl00rw-1)
  integer(kind=4), intent(in) :: n0_g_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n1_g_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n2_g_mat_u_v_oqyl00rw
  integer(kind=4), intent(in) :: n3_g_mat_u_v_oqyl00rw
  real(kind=8), intent(inout) :: g_mat_u_v_oqyl00rw(0: &
      n3_g_mat_u_v_oqyl00rw-1,0:n2_g_mat_u_v_oqyl00rw-1,0: &
      n1_g_mat_u_v_oqyl00rw-1,0:n0_g_mat_u_v_oqyl00rw-1)
  ...
  !f2py integer(kind=8) :: n0_l_mat_u_v_oqyl00rw=shape(l_mat_u_v_oqyl00rw,0)
  !f2py integer(kind=8) :: n1_l_mat_u_v_oqyl00rw=shape(l_mat_u_v_oqyl00rw,1)
  !f2py integer(kind=8) :: n2_l_mat_u_v_oqyl00rw=shape(l_mat_u_v_oqyl00rw,2)
  !f2py integer(kind=8) :: n3_l_mat_u_v_oqyl00rw=shape(l_mat_u_v_oqyl00rw,3)
  !f2py intent(c) l_mat_u_v_oqyl00rw
  !f2py integer(kind=8) :: n0_g_mat_u_v_oqyl00rw=shape(g_mat_u_v_oqyl00rw,0)
  !f2py integer(kind=8) :: n1_g_mat_u_v_oqyl00rw=shape(g_mat_u_v_oqyl00rw,1)
  !f2py integer(kind=8) :: n2_g_mat_u_v_oqyl00rw=shape(g_mat_u_v_oqyl00rw,2)
  !f2py integer(kind=8) :: n3_g_mat_u_v_oqyl00rw=shape(g_mat_u_v_oqyl00rw,3)
  !f2py intent(c) g_mat_u_v_oqyl00rw
