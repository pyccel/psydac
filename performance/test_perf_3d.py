...
def run_poisson_3d_mapping(filename, solution, f, backend, comm=None):
...
def test_perf_poisson_3d_mapping():
    ...
    d_all = OrderedDict()
    for backend in backends:
        d_all[backend['tag']] = run_poisson_3d_mapping(filename, solution, f,
                          backend=backend) 
