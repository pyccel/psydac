"""
    Solve the eigenvalue problem for the curl-curl operator in 2D with non-matching FEEC discretization
"""
import os
...
from psydac.feec.multipatch.non_matching_operators import construct_hcurl_conforming_projection
