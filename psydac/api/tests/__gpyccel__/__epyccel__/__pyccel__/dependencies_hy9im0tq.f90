...
subroutine assembly(global_test_basis_v_1, global_test_basis_v_2, &
  ...
  real(kind=8), intent(inout) :: l_mat_u_v_hy9im0tq(0:,0:,0:,0:)
  real(kind=8), intent(inout) :: g_mat_u_v_hy9im0tq(0:,0:,0:,0:)
  ...
  do i_element_1 = 0_8, n_element_1-1_8, 1_8
    ...
    do i_element_2 = 0_8, n_element_2-1_8, 1_8
      ...
      j_basis_2, i_element_2)
                  ...
                  u_x2 = u_1 * u_2_x2
                  u_x1 = u_1_x1 * u_2
                  l_mat_u_v_hy9im0tq(-i_basis_2 + j_basis_2 + pad_u_v_2, &
      -i_basis_1 + j_basis_1 + pad_u_v_1, i_basis_2, i_basis_1) = &
      l_mat_u_v_hy9im0tq(-i_basis_2 + j_basis_2 + pad_u_v_2, -i_basis_1 &
      ...
      g_mat_u_v_hy9im0tq(:, :, pad2 + span_v_2 - test_v_p2:1_8 + pad2 + &
      span_v_2 - 1_8, pad1 + span_v_1 - test_v_p1:1_8 + pad1 + span_v_1 &
      - 1_8) = g_mat_u_v_hy9im0tq(:, :, pad2 + span_v_2 - test_v_p2:1_8 &
      + pad2 + span_v_2 - 1_8, pad1 + span_v_1 - test_v_p1:1_8 + pad1 + &
      span_v_1 - 1_8) + l_mat_u_v_hy9im0tq(:, :, :, :)
    end do
  end do
...
end module dependencies_hy9im0tq
