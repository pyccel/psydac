...
def test_api_vector_laplace_2d_dir_analytical_collela():
    print('============ test_api_vector_laplace_2d_dir_analytical_collela =============')
...
#    test_api_poisson_2d_dir_analytical_collela()
    test_api_vector_laplace_2d_dir_analytical_collela()
    # ...
