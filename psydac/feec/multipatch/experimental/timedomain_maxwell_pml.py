...
from psydac.feec.multipatch.multipatch_domain_utilities import build_multipatch_domain, build_cartesian_multipatch_domain
...
def run_sim():
    ...
    degree = [3,3]
    p_moments=-1
    plot_dir = "plots/PML3/test_matching"
...
#    domain = build_multipatch_domain(domain_name='square_4')
    ...
    E0, B0 = get_Gaussian_beam(x_0=3.14/2 , y_0=3.14/2, domain=domain)
