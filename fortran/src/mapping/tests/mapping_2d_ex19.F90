...
implicit none
  ...
  real(plf_rk), parameter :: pi = 3.1415926535897931
  real(plf_rk), parameter :: angle = pi / 4.0_plf_rk
  ...
  ! ... mapping translation
  call cad % create()
  call cad % rotate(mapping, angle=angle, axis=3)
  ! ...
  ...
  ! ... exports the mapping
  call mapping % export('mapping_out.nml')
  ! ...
