...
def assembly(global_test_basis_v1_1, global_trial_basis_u1_1, global_span_v1_1, global_x1, global_w1, test_v1_p1, trial_u1_p1, n_element_1, k1, pad1, l_mat_u1_v1_quuf6pa8, g_mat_u1_v1_quuf6pa8):
        ...
        for i_basis_1 in range(0, 1 + test_v1_p1, 1):
            for j_basis_1 in range(0, 1 + trial_u1_p1, 1):
                for i_quad_1 in range(0, 3, 1):
                    ...
                    l_mat_u1_v1_quuf6pa8[i_basis_1,-i_basis_1 + j_basis_1 + pad_u1_v1_1] += 1.0*u1*v1*wvol_M/sqrt(temp0)
                
            
        
        g_mat_u1_v1_quuf6pa8[pad1 + span_v1_1 - test_v1_p1 : 1 + pad1 + span_v1_1, : ] += l_mat_u1_v1_quuf6pa8[ : , : ]
