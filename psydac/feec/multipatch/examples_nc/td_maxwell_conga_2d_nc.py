...
from psydac.feec.multipatch.examples.ppc_test_cases     import get_source_and_solution_hcurl, get_div_free_pulse, get_curl_free_pulse, get_Delta_phi_pulse, get_praxial_Gaussian_beam_E, get_easy_Gaussian_beam_E, get_easy_Gaussian_beam_B
...
#        diag_dtau        = None,
    ...
    if E0_type == 'th_sol':
        ...
        E0 = get_easy_Gaussian_beam_E(x_0=3.14, y_0=1.5*3.14, domain=domain)
        B0 = get_easy_Gaussian_beam_B(x_0=3.14, y_0=1.5*3.14, domain=domain)
