...
subroutine assembly(n0_global_test_basis_v0_1, n1_global_test_basis_v0_1 &
      ...
      trial_u0_p1, n_element_1, k1, pad1, n0_l_mat_u0_v0_zoceiy39, &
      n1_l_mat_u0_v0_zoceiy39, l_mat_u0_v0_zoceiy39, &
      n0_g_mat_u0_v0_zoceiy39, n1_g_mat_u0_v0_zoceiy39, &
      g_mat_u0_v0_zoceiy39)

  use dependencies_zoceiy39, only: mod_assembly => assembly
  ...
  integer(kind=4), intent(in) :: n0_l_mat_u0_v0_zoceiy39
  integer(kind=4), intent(in) :: n1_l_mat_u0_v0_zoceiy39
  real(kind=8), intent(inout) :: l_mat_u0_v0_zoceiy39(0: &
      n1_l_mat_u0_v0_zoceiy39-1,0:n0_l_mat_u0_v0_zoceiy39-1)
  integer(kind=4), intent(in) :: n0_g_mat_u0_v0_zoceiy39
  integer(kind=4), intent(in) :: n1_g_mat_u0_v0_zoceiy39
  real(kind=8), intent(inout) :: g_mat_u0_v0_zoceiy39(0: &
      n1_g_mat_u0_v0_zoceiy39-1,0:n0_g_mat_u0_v0_zoceiy39-1)
  ...
  !f2py integer(kind=8) :: n0_l_mat_u0_v0_zoceiy39=shape(l_mat_u0_v0_zoceiy39,0)
  !f2py integer(kind=8) :: n1_l_mat_u0_v0_zoceiy39=shape(l_mat_u0_v0_zoceiy39,1)
  !f2py intent(c) l_mat_u0_v0_zoceiy39
  !f2py integer(kind=8) :: n0_g_mat_u0_v0_zoceiy39=shape(g_mat_u0_v0_zoceiy39,0)
  !f2py integer(kind=8) :: n1_g_mat_u0_v0_zoceiy39=shape(g_mat_u0_v0_zoceiy39,1)
  !f2py intent(c) g_mat_u0_v0_zoceiy39
  call mod_assembly(global_test_basis_v0_1, global_trial_basis_u0_1, &
      ...
      n_element_1, k1, pad1, l_mat_u0_v0_zoceiy39, g_mat_u0_v0_zoceiy39 &
      )
